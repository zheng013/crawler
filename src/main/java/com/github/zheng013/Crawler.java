...
public class Crawler extends Thread {
    ...
    private void storeLinkIntoDatabaseIfIsNewsPage(Document doc, String link) throws SQLException {
    ...
    private  void parseUrlsFromPageStoreIntoDatabase(Document doc) throws SQLException {
    ...
    private  Document httpGetAndHtmlParse(String link) throws IOException {
